...
void createRegions()
{
  ...
  regions.add(new Region( suburbia, "suburbia", color(0, 255, 0), 446529, 392858 ));
  regions.add(new Region( eastside, "eastside", color(0, 255, 0), 178571, 125000 ));
  regions.add(new Region( lakeside, "lakeside", color(0, 255, 0), 297619, 181548 ));
  regions.add(new Region( southville, "southville", color(0, 255, 0), 178571, 110714 ));
  regions.add(new Region( plainville, "plainville", color(0, 255, 0), 208333, 147916 ));
  regions.add(new Region( smogtown, "smogtown", color(255, 0, 0), 29762, 27976 ));
  regions.add(new Region( westside, "westside", color(0, 255, 0), 148810, 282739 ));
  regions.add(new Region( cornertown, "cornertown", color(0, 255, 0), 59524, 258928));
  regions.add(new Region( northville, "northville", color(0, 255, 0), 119048, 95238 ));
...
class Region {
  ...
  //constructor
  Region(RShape _theShape, String _theName, color _theColour, int residents, int daytimePopulation) 
  { 
